...
5. **Functions**
    ...
    - [Checked][Scopes of Variables Inside Functions](src/functions/test_function_scopes.py) (`global` and `nonlocal` statements)
    - [Checked][Default Argument Values](src/functions/test_function_default_arguments.py)
    - [Checked][Keyword Arguments](src/functions/test_function_keyword_arguments.py)
    - [Checked][Arbitrary Argument Lists](src/functions/test_function_arbitrary_arguments.py)
    - [Checked][Unpacking Argument Lists](src/functions/test_function_unpacking_arguments.py) (`*` and `**` statements)
    - [Checked][Lambda Expressions](src/functions/test_lambda_expressions.py) (`lambda` statement)
    - [Checked][Documentation Strings](src/functions/test_function_documentation_string.py)
    - [Checked][Function Annotations](src/functions/test_function_annotations.py)
    - [Checked][Function Decorators](src/functions/test_function_decorators.py)
6. **Classes**
...
8. **Errors and Exceptions**
    - [Checked][Handling Exceptions](src/exceptions/test_handle_exceptions.py) (`try` statement)
    - [Checked][Raising Exceptions](src/exceptions/test_raise_exceptions.py) (`raise` statement) 
9. **Files**
